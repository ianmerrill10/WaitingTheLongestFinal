...
export default function StatesPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-400">-- dogs &middot; -- shelters</p>
              </div>
            </div>
          </Link>
        ))}
      ...
      {/* Summary Note */}
      <div className="mt-10 text-center py-8 bg-gray-50 rounded-xl border border-dashed border-gray-300">
        <svg
        ...
        <p className="text-gray-600 font-medium">
          Dog and shelter counts will appear once Supabase is connected
        </p>
        <p className="text-sm text-gray-500 mt-1">
          All 50 states are tracked with real-time data from shelters and rescues
        </p>
      </div>
    </div>
  );
